# -*- coding: utf-8 -*-
"""
Stores the merges from a year to the next year (e.g. from 2013 to 2016) in the file 'changes_merged_year.txt'. The structure is a JSON file with the value of the new URI, new code and new label. For example: {uri2013: {code: 2016code, label: 2016label, newuri: 2016uri} }.
